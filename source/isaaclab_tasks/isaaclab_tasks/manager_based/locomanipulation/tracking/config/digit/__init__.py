...
gym.register(
    ...
    kwargs={
        ...
        "fpo": f"{agents.__name__}.rsl_rl_ppo_cfg:DigitLocoManipFPORunnerCfg",
        "policyflow": f"{agents.__name__}.rsl_rl_ppo_cfg:DigitLocoManipPolicyFlowRunnerCfg",
        "genpo": f"{agents.__name__}.rsl_rl_ppo_cfg:DigitLocoManipGenPORunnerCfg",
