...
class DigitLocoManipPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    wandb_project = "digit_loco_manip_ppo"
...
@configclass
class DigitLocoManipFPORunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "OnPolicyFlowRunner"
    num_steps_per_env = 24
    max_iterations = 2000
    save_interval = 50
    experiment_name = "digit_loco_manip_fpo"
    wandb_project = "digit_loco_manip_fpo"
...
@configclass
class DigitLocoManipPolicyFlowRunnerCfg(RslRlOnPolicyFlowRunnerCfg):
    class_name = "OnPolicyFlowRunner"
    num_steps_per_env = 24
    max_iterations = 2000
    save_interval = 50
    experiment_name = "digit_loco_manip_policyflow"
    wandb_project = "digit_loco_manip_policyflow"
...
@configclass
class DigitLocoManipBELMGenPORunnerCfg(DigitLocoManipPPORunnerCfg):
    class_name = "OnPolicyFlowRunner"
    experiment_name = "digit_loco_manip_belmgenpo"
    wandb_project = "digit_loco_manip_belmgenpo"
