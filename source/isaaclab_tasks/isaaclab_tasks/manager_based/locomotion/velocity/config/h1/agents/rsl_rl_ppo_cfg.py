...
@configclass
class H1RoughFPORunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name = "OnPolicyFlowRunner"
    num_steps_per_env = 24
    max_iterations = 3000
    save_interval = 50
    experiment_name = "h1_rough_fpo"
    wandb_project = "h1_rough_fpo"
...
@configclass
class H1RoughPolicyFlowRunnerCfg(RslRlOnPolicyFlowRunnerCfg):
    class_name = "OnPolicyFlowRunner"
    num_steps_per_env = 24
    max_iterations = 3000
    save_interval = 50
    experiment_name = "h1_rough_policyflow"
    wandb_project = "h1_rough_policyflow"
