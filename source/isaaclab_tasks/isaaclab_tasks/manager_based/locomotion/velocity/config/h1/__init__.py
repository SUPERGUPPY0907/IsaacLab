...
gym.register(
    ...
    kwargs={
        ...
        "fpo": f"{agents.__name__}.rsl_rl_ppo_cfg:H1RoughFPORunnerCfg",
        "policyflow": f"{agents.__name__}.rsl_rl_ppo_cfg:H1RoughPolicyFlowRunnerCfg",
        "genpo": f"{agents.__name__}.rsl_rl_ppo_cfg:H1RoughGenPORunnerCfg",
        "belmgenpo": f"{agents.__name__}.rsl_rl_ppo_cfg:H1RoughBELMGenPORunnerCfg",
        "belm_genpo": f"{agents.__name__}.rsl_rl_ppo_cfg:H1RoughBELMGenPORunnerCfg",
    },
)
