...
gym.register(
    ...
    kwargs={
        ...
        "policyflow": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPolicyFlowRunnerCfg",
        ...
        "fpo": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughFPORunnerCfg",
        "fpo_pp": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughFPORunnerCfg",
        "fpo++": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughFPORunnerCfg",
...
gym.register(
    id="Isaac-Balance-G1-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.balance_env_cfg:G1BalanceEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1BalancePPORunnerCfg",
    },
)
