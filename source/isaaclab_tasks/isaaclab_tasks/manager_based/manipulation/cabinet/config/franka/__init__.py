...
gym.register(
    ...
    kwargs={
        ...
        "fpo": f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetFPORunnerCfg",
        "policyflow": f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetPolicyFlowRunnerCfg",
        "genpo": f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetGenPORunnerCfg",
        "belmgenpo": f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetBELMGenPORunnerCfg",
        "belm_genpo": f"{agents.__name__}.rsl_rl_ppo_cfg:CabinetBELMGenPORunnerCfg",
    },
